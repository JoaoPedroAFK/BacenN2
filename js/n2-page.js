    ...
    return `
        <div class="complaint-item" onclick="abrirFichaN2('${ficha.id}')">
            ...
            <div class="complaint-summary">
                ...
                ${ficha.dataEntradaAtendimento ? `<div class="complaint-detail"><strong>Data entrada Atendimento:</strong> ${formatarDataN2(ficha.dataEntradaAtendimento)}</div>` : ''}
                ${ficha.dataEntradaN2 ? `<div class="complaint-detail"><strong>Data Entrada N2:</strong> ${formatarDataN2(ficha.dataEntradaN2)}</div>` : ''}
